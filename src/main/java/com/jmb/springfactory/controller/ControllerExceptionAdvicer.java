...
public class ControllerExceptionAdvicer {
  ...
  public ApiError serverError(PersistenceLayerException e) {
    return new ApiError(INTERNAL_SERVER_ERROR_CODE, e.getClass().getSimpleName().concat(e.getMessage()));
  }
  ...
  public ApiError notFound(NotFoundException e) {
    return new ApiError(NOT_FOUND_CODE, e.getClass().getSimpleName().concat(e.getMessage()));
  }
